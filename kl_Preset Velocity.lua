...
function update() 
  if not _debounce then 
    ...
    updatetable() -- try run this in parallell
...
function checkMIDI() 
    ...
    if cnt>_cnt then -- this protects against ctrl-z undo action. But dont use ctrl-z to delete notes..
      for h=1 , #apply_to do 
    ...
    if _cnt==cnt then 
       ...
       if selected_notes==1 then 
        ...
        if change_preset_when_adjusting_velocity then 
           reaper.gmem_write(0,last_velocity) 
        end
      end
    end 
